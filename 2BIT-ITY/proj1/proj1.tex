...
\documentclass[11pt, a4paper, twocolumn] {article} 
	...
	\usepackage{times} 
	%\usepackage[T1]{fontenc} - nepouzivat inak sa nebude zhodovat zalamovanie
    \usepackage{hyperref}
    \hypersetup{pdfborder = {0 0 0}} %odstranenie ramceka okolo indexu
    \newcommand{\myuv}[1]{\quotedblbase #1\textquotedblleft} %prikaz pre \uv na merlinovi nefunguje 

\title{Typografie a publikování \\ 1. projekt}
\author{Peter Tisovčík \\ xtisov00@stud.fit.vutbr.cz}
\date{} %nezobrazenie datumu 
